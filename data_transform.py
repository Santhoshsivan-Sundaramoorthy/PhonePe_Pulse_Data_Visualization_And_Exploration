...
def dataCleaning():
    ...
    topTransactionDistrict_Data_State = {'State': [], 'Year': [], 'Quarter': [], 'District': [],
                                         'Transaction_count': [],
                                         'Transaction_amount': []}
    ...
    return df_aggregated_transaction_AllIndia, df_aggregated_transaction_state, df_aggregated_user_AllIndia, df_aggregated_user_state, df_map_transaction_AllIndia, df_map_transaction_state, df_map_user_AllIndia, df_map_user_state, df_top_transactionState_AllIndia, df_top_transactionDistrict_AllIndia, df_top_transactionPinCode_AllIndia, df_top_transactionDistrict_State, df_top_transactionPinCode_State, df_top_UserState_AllIndia, df_top_UserDistrict_AllIndia, df_top_UserPinCode_AllIndia, df_top_UserDistrict_state, df_top_UserPinCode_state

def tableCreationandDataInsertion(host,user,password):
    gitfile()
    df_aggregated_transaction_AllIndia, df_aggregated_transaction_state, df_aggregated_user_AllIndia, df_aggregated_user_state, df_map_transaction_AllIndia, df_map_transaction_state, df_map_user_AllIndia, df_map_user_state, df_top_transactionState_AllIndia, df_top_transactionDistrict_AllIndia, df_top_transactionPinCode_AllIndia, df_top_transactionDistrict_State, df_top_transactionPinCode_State, df_top_UserState_AllIndia, df_top_UserDistrict_AllIndia, df_top_UserPinCode_AllIndia, df_top_UserDistrict_state, df_top_UserPinCode_state = dataCleaning()
    ...
    try:
        ...
        # Handle the exception here, e.g., show a user-friendly message
        print("An error occurred while connecting to the database:", err)
        # You can choose to return an error message or take appropriate action
        return "An error occurred while connecting to the database. Please check your input."
    return 'Data Added Succeefully'
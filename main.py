    ...
    if selected_state == "All India":
        if selected_type == "Transaction":
            ...
            with coll2:
                ...
                fig3 = px.choropleth(df2, locations='Id', geojson=india_states, color='Count', hover_name="State",hover_data=['Count', 'Amount'], title="PhonePe Transaction", color_continuous_scale=custom_color)
        ...
        if selected_type == "User":
            ...
            for feature in india_states["features"]:
                ...
                state_id_map[feature["properties"]["st_nm"]] = feature["id"]
            df2['Id'] = df2["State"].apply(lambda x: state_id_map[x])
            fig3 = px.choropleth(df2, locations='Id', geojson=india_states, color='Registered User', hover_name="State", title="PhonePe Users",
